...
%_beam.pdf:%.md
	/usr/lib/rstudio/bin/pandoc/pandoc $< --to beamer --from markdown+autolink_bare_uris+ascii_identifiers+tex_math_single_backslash-implicit_figures --output $@ --template /media/jdamon/Development/Tools/R/3.1/lib/R/library/rmarkdown/rmd/beamer/default.tex --highlight-style tango
